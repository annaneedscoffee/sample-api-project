...
Example REST API
- API version: 1.0
  - Build date: 2025-03-18T03:54:25.710375+03:00[Europe/Moscow]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**echo**](docs/DefaultApi.md#echo) | **POST** /api/echo | Echo
*DefaultApi* | [**greet**](docs/DefaultApi.md#greet) | **GET** /api/greet | Greet
